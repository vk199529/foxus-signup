...
async function rules(client, argv) {
  if (argv.length === 0) {
    const lsFn = (await import("./ls-GYN5LXZK.js")).default;
    return lsFn(client, []);
  }
  ...
  switch (subcommand) {
    case "ls":
      return (await import("./ls-GYN5LXZK.js")).default(client, args);
    case "add":
      return (await import("./add-XFFRWMRQ.js")).default(client, args);
    case "inspect":
      return (await import("./rule-inspect-QVOVMKDK.js")).default(client, args);
    case "rm":
      return (await import("./rm-55RGOT4O.js")).default(client, args);
    case "update":
      return (await import("./update-E5UAD2DD.js")).default(client, args);
    default:
